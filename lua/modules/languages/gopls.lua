  ...
  vim.system(cmd, { text = true }, function(output)
    ...
    if output.code == 0 and res ~= "" then
      ...
      vim.schedule(function()
        vim.notify(("[gopls] identify %s dir failed with code %d: %s\n%s"):format(
...
M.setup = function()
  vim.g.mason_tools = utils.add_unique(vim.g.mason_tools, "gopls")
  vim.g.lsp_servers = utils.add_unique(vim.g.lsp_servers, "gopls")
